...
var OrderGoodsForm = new Class(/** @lends OrderGoodsForm# */{
	...
	initialize: function (element) {
		...
		this.element.getElement('[name=shop_orders_goods[goods_quantity]]')
			.addEvent('keyup', this.recalculateTotals.bind(this))
			.addEvent('change', this.recalculateTotals.bind(this));
		this.element.getElement('[name=shop_orders_goods[goods_amount]]').setAttribute('readonly', 'readonly');
